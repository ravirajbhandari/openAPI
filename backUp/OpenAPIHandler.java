...
public class OpenAPIHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
	...
	public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
		...
		try {
			myString = createConnectionAndInvokeGETREST(null,null);
		} catch (Exception e) {
			myString = "Oops Exception occured";
			e.printStackTrace();
		}
		Response responseBody = new Response("Go Serverless v1.x! Your function executed successfully!"+myString, input);
	...
	public void createConnectionAndInvokeREST(String inputUrl,String inputJSON,String headerInfo,String headerKey, String methodType) throws IOException{
		HttpURLConnection conn=null;
		try{
			String acessToken="<oauthToken>";
		URL url = new URL(inputUrl);
	...
	*/	boolean isDelete =false;
	...
	public String createConnectionAndInvokeGETREST(String inputUrl,String methodType) throws IOException{
		HttpURLConnection conn=null;
		try{
		...
		URL url = new URL(inputUrl);
		String cacheValue = "";
		String acessToken="DirectLogin token=\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyIiOiIifQ.wIHlGoLmYzX4743AGTQDff4kdPw8ezcgvrsbF6vn71Q\"";
